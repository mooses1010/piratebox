...
# --- Outdoor & Field ---------------------------------------------------------
for t in load("outdoor", "reference.json"):
    index.append(entry(
        t.get("title", ""), "outdoor", "Outdoor & Field Reference",
        f"/utility/outdoor/#{t.get('id', '')}",
        t.get("summary", ""), t.get("keywords"),
    ))
...
for title, url, snippet, keywords in [
    ...
    ("Multimeter & Measurement Basics", "/utility/fieldtools/units/",
     "Continuity, DC voltage, resistance, and current measurement basics, with a labeled VOM diagram - not a live/mains-circuit procedure.",
     ["multimeter", "vom", "volt-ohm-milliammeter", "continuity", "voltage measurement", "resistance measurement", "test equipment", "electrical measurement"]),
