...
<body>
    ...
    <section class="help-section">
        ...
        <ul class="help-steps">
            ...
            <li><strong>Chat</strong> with others currently connected, or sign the <a href="/messages.php">Logbook</a> - leave your name, a note, or just mark that you were here.</li>
