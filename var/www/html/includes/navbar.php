<nav class="navbar">
    ...
    <ul class="navbar-menu" id="primary-nav">
        ...
        <li><a href="/#upload-form">Upload</a></li>
        <li><a href="chat.php">Chat<span id="badge-chat" class="badge"></span></a></li>
        <li><a href="messages.php">Guestbook<span id="badge-messages" class="badge"></span></a></li>
